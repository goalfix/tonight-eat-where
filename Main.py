...
mrt = ['admiralty', 'aljunied', 'ang-mo-kio', 'balestier', 'bartley', 'bayfront', 'beach-road', 'beauty-world', 'bedok', 'bedok-north', 'bencoolen', 'bendemeer', 'bishan', 'boat-quay', 'boon-keng', 'boon-lay', 'botanic-gardens', 'braddell', 'bras-basah', 'bugis', 'bukit-batok', 'bukit-gombak', 'bukit-merah', 'bukit-panjang', 'bukit-timah', 'buona-vista', 'canberra', 'changi', 'changi-airport', 'chinatown', 'chinese-garden', 'choa-chu-kang', 'city-hall', 'clarke-quay', 'clementi', 'club-street', 'commonwealth', 'dakota', 'dempsey', 'dhoby-ghaut', 'dover', 'downtown', 'duxton', 'east-coast', 'esplanade', 'eunos', 'expo', 'farrer-park', 'farrer-road', 'fort-canning', 'geylang', 'geylang-bahru', 'great-world', 'harbourfront', 'holland-village', 'hougang', 'jalan-besar', 'joo-chiat', 'jurong', 'jurong-east', 'kallang', 'kampong-bahru', 'katong', 'kembangan', 'kent-ridge', 'keong-saik', 'khatib', 'king-albert-park', 'kovan', 'kranji', 'labrador-park', 'lakeside', 'lavender', 'little-india', 'lorong-chuan', 'macpherson', 'marina-bay', 'marine-parade', 'marsiling', 'marymount', 'mountbatten', 'neil-road', 'newton', 'nicoll-highway', 'novena', 'one-north', 'orchard', 'orchard-road', 'outram', 'outram-park', 'pasir-panjang', 'pasir-ris', 'paya-lebar', 'paya-lebar', 'pioneer', 'potong-pasir', 'promenade', 'punggol', 'queenstown', 'raffles-place', 'redhill', 'river-valley', 'robertson-quay', 'rochester', 'rochor', 'seletar', 'sembawang', 'sengkang', 'sentosa', 'serangoon', 'siglap', 'simei', 'sixth-avenue', 'somerset', 'stadium', 'suntec', 'tai-seng', 'tampines', 'tanah-merah', 'tanglin', 'tanjong-pagar', 'telok-ayer', 'telok-blangah', 'thomson', 'tiong-bahru', 'toa-payoh', 'ubi', 'upper-changi', 'west-coast', 'woodlands', 'yio-chu-kang', 'yishun']
